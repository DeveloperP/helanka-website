        ...
        <div className="max-w-[1440px] mx-auto px-8 md:px-24 lg:px-32 flex gap-6 overflow-x-auto scrollbar-hide py-4">
          {regions.map((region) => (
            <button
              ...
              className={`text-sm hover:text-primary transition-colors whitespace-nowrap font-semibold tracking-wide ${
                activeRegion === region ? "text-primary" : "text-on-surface-muted"
              }`}
