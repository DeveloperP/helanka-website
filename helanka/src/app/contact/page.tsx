        ...
        <div className="max-w-[1440px] mx-auto px-8 md:px-24 lg:px-32">
          <div className="grid lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="bg-[#ff9d00]/10 border border-[#ff9d00]/30 rounded-2xl p-12 text-center">
                  <div className="w-16 h-16 bg-[#ff9d00] rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg
                      className="w-8 h-8 text-[#482900]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2.5}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {tripTypes.map((type) => (
                        <label key={type} className="cursor-pointer">
                          ...
                          />
                          <span className="inline-block px-4 py-2 text-sm rounded-full border border-white/10 text-white/60 peer-checked:border-[#ff9d00] peer-checked:bg-[#ff9d00]/10 peer-checked:text-[#ff9d00] hover:border-white/30 transition-all">
                            {type}
                          </span>
                        </label>
                      ))}
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[#ff9d00]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-5 h-5 text-[#ff9d00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-[#ff9d00] hover:border-[#ff9d00]/30 transition-all text-xs font-bold"
                      title={s.label}
                    >
                      {s.label[0]}
                    </a>
