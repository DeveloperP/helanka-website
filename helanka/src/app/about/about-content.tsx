  ...
  return (
    <>
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
        <div
          role="img"
          aria-label="Nine Arch Bridge in Ella, Sri Lanka"
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: "url('/images/public-ella-nine-arch.webp')" }}
        />
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-8 md:px-24 lg:px-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div ref={storyImgRef} className="reveal relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden">
              <div
                role="img"
                aria-label="Beach scene in southern Sri Lanka"
                className="absolute inset-0 bg-cover bg-center"
                style={{ backgroundImage: "url('/images/public-down-south-beach.webp')" }}
              />
